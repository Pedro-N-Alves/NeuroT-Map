...
for lesion in ${lesions[@]}; do
	maps_r=(A4B2 M1 VAChT D1 D2 DAT NAT 5HT1a 5HT1b 5HT2a 5HT4 5HT6 5HTT)
	maps_t=(A4B2 M1 VAChT D1 D2 DAT NAT 5HT1a 5HT1b 5HT2a 5HT4 5HT6 5HTT)
	...
	for i in ${maps_t[@]}; do
		labels+=( ${i}"_con" )
		total_mean=$(fslstats ./functionnectome_maps/anat/functionnectome_anat_${i}.nii.gz -M | awk '{print $1}')
		total_voxels=$(fslstats ./functionnectome_maps/anat/functionnectome_anat_${i}.nii.gz -V | awk '{print $1}')
		total=$(echo $total_mean $total_voxels | awk '{printf "%4.3f\n",$1*$2}')
		totals+=(${total})
		fslmaths ./functionnectome_maps/anat/functionnectome_anat_${i}.nii.gz -mas ./lesions/${lesion}.nii.gz functionnectome_anat_${i}_mas_lesion.nii.gz
