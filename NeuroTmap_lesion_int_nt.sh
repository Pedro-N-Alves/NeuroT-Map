...
for lesion in ${lesions[@]}; do
	...
	for i in ${maps_loc[@]}; do
		labels+=( ${i}"_loc" )
		total_mean=$(fslstats ./PET_nifti_images/${i}_median_scale01_mas_AAL3plusnuclei.nii.gz -M | awk '{print $1}')
		total_voxels=$(fslstats ./PET_nifti_images/${i}_median_scale01_mas_AAL3plusnuclei.nii.gz -V | awk '{print $1}')
		total=$(echo $total_mean $total_voxels | awk '{printf "%4.3f\n",$1*$2}')
		totals+=(${total})
		fslmaths ./PET_nifti_images/${i}_median_scale01_mas_AAL3plusnuclei.nii.gz -mas ./lesions/${lesion}.nii.gz ${i}_median_scale01_mas_AAL3plusnuclei_mas_lesion.nii.gz
	...
	for i in ${maps_tract[@]}; do
		labels+=( ${i}"_con" )
		total_mean=$(fslstats ./functionnectome_maps/functionnectome_anat_${i}_from_AAL3plusnuclei.nii.gz -M | awk '{print $1}')
		total_voxels=$(fslstats ./functionnectome_maps/functionnectome_anat_${i}_from_AAL3plusnuclei.nii.gz -V | awk '{print $1}')
		total=$(echo $total_mean $total_voxels | awk '{printf "%4.3f\n",$1*$2}')
		totals+=(${total})
		fslmaths ./functionnectome_maps/functionnectome_anat_${i}_from_AAL3plusnuclei.nii.gz -mas ./lesions/${lesion}.nii.gz functionnectome_anat_${i}_from_AAL3plusnuclei_mas_lesion.nii.gz
	...
	for i in ${maps_max[@]}; do
		labels+=( ${i}"_max" )
		total_mean=$(fslstats ./max_maps/${i}_anat_AAL3plusnuclei_max_map.nii.gz -M | awk '{print $1}')
		total_voxels=$(fslstats ./max_maps/${i}_anat_AAL3plusnuclei_max_map.nii.gz -V | awk '{print $1}')
		total=$(echo $total_mean $total_voxels | awk '{printf "%4.3f\n",$1*$2}')
		totals+=(${total})
		fslmaths ./max_maps/${i}_anat_AAL3plusnuclei_max_map.nii.gz -mas ./lesions/${lesion}.nii.gz ${i}_anat_AAL3plusnuclei_max_map_mas_lesion.nii.gz
