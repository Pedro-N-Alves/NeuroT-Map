...
def individual_profile():
    for lesion in args.lesions:
        ...
        all_inj = tab.loc['injuries', ['A4B2_loc', 'M1_loc', 'VAChT_loc', 'D1_loc', 'D2_loc', 'DAT_loc', 'NAT_loc', '5HT1a_loc', '5HT1b_loc', '5HT2a_loc', '5HT4_loc', '5HT6_loc', '5HTT_loc', 'GABAa_loc', 'mGluR5_loc', 'MU_loc', 'H3_loc', 'CB1_loc']]
        all_tot = tab.loc['totals', ['A4B2_loc', 'M1_loc', 'VAChT_loc', 'D1_loc', 'D2_loc', 'DAT_loc', 'NAT_loc', '5HT1a_loc', '5HT1b_loc', '5HT2a_loc', '5HT4_loc', '5HT6_loc', '5HTT_loc', 'GABAa_loc', 'mGluR5_loc', 'MU_loc', 'H3_loc', 'CB1_loc']]
        all_perc = all_inj/all_tot*100

        all_tract_inj = tab.loc['injuries', ['A4B2_con', 'M1_con', 'VAChT_con', 'D1_con', 'D2_con', 'DAT_con', 'NAT_con', '5HT1a_con', '5HT1b_con', '5HT2a_con', '5HT4_con', '5HT6_con', '5HTT_con', 'GABAa_con', 'mGluR5_con', 'MU_con', 'H3_con', 'CB1_con']]
        all_tract_tot = tab.loc['totals', ['A4B2_con', 'M1_con', 'VAChT_con', 'D1_con', 'D2_con', 'DAT_con', 'NAT_con', '5HT1a_con', '5HT1b_con', '5HT2a_con', '5HT4_con', '5HT6_con', '5HTT_con', 'GABAa_con', 'mGluR5_con', 'MU_con', 'H3_con', 'CB1_con']]
        ...
        output_les_dis = pd.DataFrame(output_les_dis, columns=['A4B2', 'M1', 'VAChT', 'D1', 'D2', 'DAT', 'Nor', '5HT1a', '5HT1b', '5HT2a', '5HT4', '5HT6', '5HTT', 'GABAa', 'mGluR5', 'MU', 'H3', 'CB1'], index=['loc_inj_'+str(lesion), 'loc_inj_perc_'+str(lesion), 'tract_inj_'+str(lesion), 'tract_inj_perc_'+str(lesion)])
        output_les_dis.to_csv('output_les_dis_datad_'+str(lesion)+'.csv', sep=" ", header=True, index=True)

		# Create output_pre_post_synaptic_ratio_datad_'lesion_name'.csv (please see README file for more details)
        ...
        pre_pos_ratio.to_csv('output_pre_post_synaptic_ratio_datad_'+str(lesion)+'.csv', sep=" ", header=True, index=True)
